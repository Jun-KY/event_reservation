package com.jun.event_reservation.controller;

import com.jun.event_reservation.dto.ReservationDto;
import com.jun.event_reservation.model.Reservation;
import com.jun.event_reservation.service.ReservationService;
...
public class ReservationController {
    ...
    @GetMapping("/api/event/{eventId}/reservations")
    ...
    @PostMapping("/api/event/{eventId}/reservations")
